    ...
    <>
      ...
      <section class="flex flex-col gap-4">
        <Field label={t("profile.account.displayName")}>
          <input
            ...
            class="bg-surface-dark border border-border-dark rounded-lg h-9 px-2 text-base text-text-primary focus:border-accent-blue focus:ring-1 focus:ring-accent-blue outline-none transition-colors w-full"
          />
        ...
        <Field label={t("profile.account.language")} bordered>
          <div class="relative w-fit min-w-[200px]" ref={langRef}>
            <button
              ...
              class="bg-surface-dark border border-border-dark rounded-lg h-9 px-3 text-sm text-text-primary focus:border-accent-blue focus:ring-1 focus:ring-accent-blue outline-none transition-colors w-full flex items-center justify-between gap-2 cursor-pointer"
            >
        ...
        <div class="flex items-center justify-end gap-3 pt-2">
          ...
          <button
            ...
            class="px-6 py-2 bg-cta text-cta-fg rounded-lg text-sm font-bold hover:bg-cta-hover transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
          >
      ...
      <section class="flex flex-col gap-2 pt-8 border-t border-border-dark mt-8">
        <a
          ...
          class="flex items-center gap-4 p-2 rounded-lg hover:bg-overlay-faint text-text-primary transition-colors text-left w-full h-11 no-underline"
        >
        ...
        <button
          ...
          class="flex items-center gap-4 p-2 rounded-lg hover:bg-overlay-faint text-text-primary transition-colors text-left w-full h-11 cursor-pointer bg-transparent border-none"
        >
        ...
        <button
          ...
          class="flex items-center gap-4 p-2 rounded-lg hover:bg-danger/10 text-danger transition-colors text-left w-full h-11 mt-4 cursor-pointer bg-transparent border-none"
        >
        ...
        <div class="p-6 flex flex-col gap-4">
          ...
          <div class="flex justify-end gap-3 mt-2">
            <button
              ...
              class="px-5 py-2.5 rounded-lg font-bold text-sm text-text-muted-dark hover:bg-overlay-faint transition-colors cursor-pointer bg-transparent border-none"
            >
              {t("profile.cancel")}
            </button>
            <button
              ...
              class="px-5 py-2.5 bg-cta text-cta-fg text-sm font-bold rounded-lg hover:bg-cta-hover transition-colors cursor-pointer border-none"
            >
        ...
        <div class="p-6 flex flex-col gap-4">
          ...
          <div class="flex flex-col gap-2">
            ...
            <input
              ...
              autocomplete="off"
              class="w-full px-4 py-2.5 bg-surface-container-high border border-border-dark rounded-lg focus:ring-1 focus:ring-danger focus:border-danger outline-none transition-all text-text-primary"
            />
          </div>
          <div class="flex justify-end gap-3 mt-2">
            <button
